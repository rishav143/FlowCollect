...
const TEMPLATES: Record<string, unknown>[] = [
  { id: 't1', name: 'Friendly Reminder',    channel: 'EMAIL',    subject: 'Friendly reminder — Invoice {{invoiceNumber}} is due', body: 'Hi {{customerName}},\n\nJust a friendly reminder that Invoice {{invoiceNumber}} for {{remainingAmount}} is due on {{dueDate}}.\n\nPlease let us know if you have any questions.\n\nThanks,\n{{organizationName}}', tone: 'POLITE',  active: true,  createdAt: NOW, updatedAt: NOW },
  { id: 't2', name: 'Overdue Notice',       channel: 'EMAIL',    subject: 'Overdue — Invoice {{invoiceNumber}}',                  body: 'Dear {{customerName}},\n\nInvoice {{invoiceNumber}} for {{remainingAmount}} was due on {{dueDate}} and remains unpaid.\n\nPlease arrange payment at the earliest.\n\nRegards,\n{{organizationName}}',                 tone: 'FIRM',    active: true,  createdAt: NOW, updatedAt: NOW },
  { id: 't3', name: 'WhatsApp Quick Nudge', channel: 'WHATSAPP', subject: null,                                                   body: 'Hi {{customerName}}! Reminder — Invoice {{invoiceNumber}} ({{remainingAmount}}) is due {{dueDate}}. Pay here: {{paymentLink}}',                                                                                           tone: 'NEUTRAL', active: false, createdAt: NOW, updatedAt: NOW },
]
